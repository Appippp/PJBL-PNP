...
@section('content')
    ...
    <section class="content">
        <div class="box">
            ...
            <!-- Form -->
            <form action="{{ route('backsite.dosen.store') }}" method="POST">
                @csrf
                <div class="box-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="nidn" name="nidn" value="{{ old('nidn') }}" placeholder="Masukkan Nomor Induk Mahasiswa" required>
                            @error('nidn')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="nama_dosen" name="nama_dosen" value="{{ old('nama_dosen') }}" placeholder="Masukkan Nama Lengkap Mahasiswa" required>
                            @error('nama_dosen')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select name="prodi_id" id="prodi_id" class="form-control select2" required>
                                <option value="" disabled {{ old('prodi_id') == null ? 'selected' : '' }}>-- Pilih Prodi --</option>
                                @foreach ($prodi as $prodi_item)
                                    <option value="{{ $prodi_item->id }}" {{ old('prodi_id') == $prodi_item->id ? 'selected' : '' }}>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="no_telp" name="no_telp" value="{{ old('no_telp') }}" placeholder="Masukkan Nomor Telpon / Whatsapp">
                            @error('no_telp')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <textarea name="alamat" id="alamat" class="form-control" cols="30" rows="2">{{ old('alamat') }}</textarea>
                            @error('alamat')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-sm-6">
                            <select name="user_id" id="user_id" class="form-control select2" required>
                                ...
                                @foreach ($user as $user_item)
                                    <option value="{{ $user_item->id }}" {{ old('user_id') == $user_item->id ? 'selected' : '' }}>
                                        {{ $user_item->username }}
                                    </option>
                                @endforeach
                            </select>
