 <!-- Bootstrap 3.3.5 -->
 <link rel="stylesheet" href="{{ asset('assets/backsite/bootstrap/css/bootstrap.min.css') }}">
 <!-- Font Awesome -->
 ...
 <!-- Date Picker -->
 <link rel="stylesheet" href="{{ asset('assets/backsite/plugins/datepicker/datepicker3.css') }}">
 <!-- Daterange picker -->
